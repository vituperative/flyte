...
<head>
  ...
  <link rel="alternate" type="application/rss+xml" title="Torrent Freedom RSS Feed" href=rss.php />
...
<body>
  <table class="borderTable" border="0" cellpadding="2" cellspacing="0" width="100%">
    <tr>
      <td class="title" valign="middle">
        ...
        <table border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td style="font-size: 22px; text-align: left; vertical-align: middle;">Tracker runs <?php $birthday = new DateTime('2017-06-11'); $now = new DateTime(); echo $birthday->diff($now)->format('%a days');?></td>
          </tr>
        </table>
      </td>
    </tr>
	...
	<br><b>Contact:</b> <code>torrfreedom@mail.i2p</code> | <b>Theme created by:</b> <code>dr|z3d</code>
	<hr class="separator">
        </td>
    </tr>
  </table>
